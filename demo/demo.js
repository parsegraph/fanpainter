...
app.get('/', async (req, res) => {
  ...
  write(`<html>`);
  write(`<head>`);
  write(`<title>fanpainter</title>`);
  write(`</head>`);
  write(`<body>`);
  write(`<h1>fanpainter <a href='/coverage'>Coverage</a> <a href='/docs'>Docs</a></h1>`);
  write(`<p>This library is available as JavaScript UMD module: <a href='/parsegraph-fanpainter.js'>parsegraph-fanpainter.js</a></p>`);
...
app.listen(port, () => {
  console.log(`See fanpainter build information at http://localhost:${port}`);
});
